...
console.log('ELEVENLABS_API_KEY length:', ELEVENLABS_API_KEY ? ELEVENLABS_API_KEY.length : 'NOT FOUND');
...
console.log('ELEVENLABS_API_KEY starts with:', ELEVENLABS_API_KEY ? ELEVENLABS_API_KEY.substring(0, 10) + '...' : 'NO KEY');
